              ...
              <div className="border border-gray-200 rounded-md overflow-hidden">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-gray-700">Archivos Generales</span>
                    <span className="text-xs text-gray-500 bg-white px-1.5 py-0.5 rounded-full">
                      {filesBySource.files.length}
                    </span>
                  </div>
                ...
                {expandedSections.has('files') && (
                  <div className="p-3 bg-white space-y-3">
                    {Object.entries(filesByFolder).map(([folderId, folder]) => (
                      <div key={folderId}>
                        <h3 className="text-xs font-medium text-gray-600 mb-1.5 flex items-center gap-1.5">
              ...
              <div className="border border-gray-200 rounded-md overflow-hidden">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-gray-700">Documentos de Operaciones</span>
                    <span className="text-xs text-gray-500 bg-white px-1.5 py-0.5 rounded-full">
                      {filesBySource.operations.length}
                    </span>
                  </div>
                ...
                {expandedSections.has('operations') && (
                  <div className="p-3 bg-white space-y-3">
                    {Object.entries(filesByOperation).map(([opRef, files]) => (
                      <div key={opRef}>
                        <h3 className="text-xs font-medium text-gray-600 mb-1.5">{opRef}</h3>
                        <div className={viewMode === 'grid' 
                          ? 'grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-2'
                          : 'space-y-1'
                        }>
              ...
              <div className="border border-gray-200 rounded-md overflow-hidden">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-gray-700">Archivos de Emails</span>
                    <span className="text-xs text-gray-500 bg-white px-1.5 py-0.5 rounded-full">
                      {filesBySource.emails.length}
                    </span>
                  </div>
