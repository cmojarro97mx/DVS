              ...
              <div className="flex gap-2 min-w-max">
                {email.attachmentsData.map((att: any, index: number) => {
                  ...
                  return (
                    <div
                      key={index}
                      className="group relative flex-shrink-0 w-28 bg-white border border-gray-200 rounded-lg overflow-hidden hover:border-blue-400 hover:shadow-md transition-all"
                    >
                      {/* Preview Area */}
                      <div 
                        className="relative h-20 bg-gray-100 flex items-center justify-center cursor-pointer"
                        ...
                        {isImage && att.url ? (
                          <img 
                            ...
                            onError={(e) => {
                              ...
                              e.currentTarget.parentElement!.innerHTML = '<div class="flex items-center justify-center w-full h-full"><svg class="w-10 h-10 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path></svg></div>';
                            }}
                          />
                        ) : (
                          <div className="flex flex-col items-center justify-center p-2">
                            {getFileIcon(att.filename)}
                            <span className="text-[9px] text-gray-500 mt-1 uppercase font-medium">
                        ...
                        <div className="absolute inset-0 bg-black/0 group-hover:bg-black/50 transition-all flex items-center justify-center opacity-0 group-hover:opacity-100">
                          <div className="flex gap-1.5">
                            <button
                              ...
                              className="p-1.5 bg-white/95 hover:bg-white rounded-full transition-colors"
                              title="Ver"
                              type="button"
                            >
                      ...
                      <div className="px-2 py-1.5 border-t border-gray-100">
                        <p className="text-[10px] font-medium text-gray-900 truncate" title={att.filename}>
                          {att.filename}
                        </p>
