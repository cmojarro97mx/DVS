...
interface CreateRuleLinkingModalProps {
  isOpen: boolean;
  onClose: () => void;
...
export const CreateRuleLinkingModal: React.FC<CreateRuleLinkingModalProps> = ({
  isOpen,
  onClose,
  onSave,
}) => {
      ...
      >
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 rounded-t-xl z-10">
          <div className="flex items-center justify-between">
            <h2 className="text-xl font-bold text-gray-900">Nueva Regla de Vinculación</h2>
            <button
              onClick={handleCancel}
